...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Modern, professional color palette for business tools
        primary: {
          50: "#eff6ff",
          100: "#dbeafe",
          200: "#bfdbfe",
        ...
        diagram: {
          spine: "#374151", // Main fishbone spine
          bone: "#6b7280", // Category bones
          cause: "#9ca3af", // Cause lines
          text: "#111827", // Text color
          highlight: "#fbbf24", // Highlight color
